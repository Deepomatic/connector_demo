...
export class ConnectorComponent implements OnInit {
  ...
  public get oneClickToken(): string {
  ...
  public onAddItemClicked() {
    ...
    if (this.workOrderId) {
      ...
      paramsObj['wo_metadata'] = Buffer.from(JSON.stringify({
        ...
        "mobile_application_user": "dave.stevens@indigotg.com"
      })).toString('base64');
    }
  ...
  public getCardClass(analysisStatus: AnalysisStatus): string {
    switch (analysisStatus) {
      case 'analysis_ok':
        return 'card-ok';
      case 'analysis_ko':
        return 'card-error';
      case 'canceled_picture':
        return 'card-warning';
